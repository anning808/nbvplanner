...
class GazeboWingModelPlugin : public ModelPlugin {
 ...
 protected:
  ...
  ignition::math::Vector3<double> get_aerodynamic_forces(ignition::math::Vector3<double> &vel);
  ignition::math::Vector3<double> get_aerodynamic_moments(ignition::math::Vector3<double> &vel);
 ...
 private:
  ...
  ignition::math::Quaternion<double> _q;
